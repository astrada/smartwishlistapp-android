...
public class Smartwishlist extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.22.0 of the smartwishlist library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class AppNotifications {
    ...
    /**
     * Create a request for the method "appNotifications.delete".
     *
     ...
     * @return the request
     */
    public Delete delete(java.lang.String clientId, java.lang.Double timestamp, java.lang.String signature, com.appspot.smart_wish_list.smartwishlist.model.SmartWishListRegisterGcmDeviceParameters content) throws java.io.IOException {
    ...
    public class Delete extends SmartwishlistRequest<Void> {
      ...
      private static final String REST_PATH = "delete-gcm-device";
       ...
       * @since 1.13
       */
      protected Delete(java.lang.String clientId, java.lang.Double timestamp, java.lang.String signature, com.appspot.smart_wish_list.smartwishlist.model.SmartWishListRegisterGcmDeviceParameters content) {
  ...
  public class Client {
    ...
    /**
     * Create a request for the method "client.updateLanguage".
     *
     * This request holds the parameters needed by the smartwishlist server.  After setting any optional
     ...
     * @param timestamp
     * @param signature
     * @param content the {@link com.appspot.smart_wish_list.smartwishlist.model.SmartWishListLanguageData}
     * @return the request
     */
    public UpdateLanguage updateLanguage(java.lang.String clientId, java.lang.Double timestamp, java.lang.String signature, com.appspot.smart_wish_list.smartwishlist.model.SmartWishListLanguageData content) throws java.io.IOException {
      UpdateLanguage result = new UpdateLanguage(clientId, timestamp, signature, content);
      initialize(result);
      return result;
    }

    public class UpdateLanguage extends SmartwishlistRequest<Void> {

      private static final String REST_PATH = "updatelanguage";
       ...
       * @since 1.13
       */
      protected UpdateLanguage(java.lang.String clientId, java.lang.Double timestamp, java.lang.String signature, com.appspot.smart_wish_list.smartwishlist.model.SmartWishListLanguageData content) {
        super(Smartwishlist.this, "POST", REST_PATH, content, Void.class);
        this.clientId = com.google.api.client.util.Preconditions.checkNotNull(clientId, "Required parameter clientId must be specified.");
        this.timestamp = com.google.api.client.util.Preconditions.checkNotNull(timestamp, "Required parameter timestamp must be specified.");
        this.signature = com.google.api.client.util.Preconditions.checkNotNull(signature, "Required parameter signature must be specified.");
      ...
      public UpdateLanguage setClientId(java.lang.String clientId) {
        this.clientId = clientId;
        return this;
      }
      ...
      public UpdateLanguage setTimestamp(java.lang.Double timestamp) {
        this.timestamp = timestamp;
        return this;
      }
      ...
      public UpdateLanguage setSignature(java.lang.String signature) {
        this.signature = signature;
        return this;
      }
      ...
      public UpdateLanguage setIsApp(java.lang.Boolean isApp) {
        this.isApp = isApp;
        return this;
      }
  ...
  public class Wishlist {
    ...
    /**
     * Create a request for the method "wishlist.delete".
     *
     * This request holds the parameters needed by the smartwishlist server.  After setting any optional
     * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
     *
     ...
     * @param timestamp
     * @param signature
     * @param content the {@link com.appspot.smart_wish_list.smartwishlist.model.SmartWishListDeleteWishListData}
     * @return the request
     */
    public Delete delete(java.lang.String clientId, java.lang.Double timestamp, java.lang.String signature, com.appspot.smart_wish_list.smartwishlist.model.SmartWishListDeleteWishListData content) throws java.io.IOException {
      Delete result = new Delete(clientId, timestamp, signature, content);
      initialize(result);
      return result;
    }
    ...
    public class Delete extends SmartwishlistRequest<Void> {
      ...
      private static final String REST_PATH = "deletewishlist";
       ...
       * @since 1.13
       */
      protected Delete(java.lang.String clientId, java.lang.Double timestamp, java.lang.String signature, com.appspot.smart_wish_list.smartwishlist.model.SmartWishListDeleteWishListData content) {
        super(Smartwishlist.this, "POST", REST_PATH, content, Void.class);
        this.clientId = com.google.api.client.util.Preconditions.checkNotNull(clientId, "Required parameter clientId must be specified.");
        this.timestamp = com.google.api.client.util.Preconditions.checkNotNull(timestamp, "Required parameter timestamp must be specified.");
        this.signature = com.google.api.client.util.Preconditions.checkNotNull(signature, "Required parameter signature must be specified.");
    ...
    /**
     * Create a request for the method "wishlist.update".
     *
     * This request holds the parameters needed by the smartwishlist server.  After setting any optional
     * parameters, call the {@link Update#execute()} method to invoke the remote operation.
     *
     ...
     * @param timestamp
     * @param signature
     * @param content the {@link com.appspot.smart_wish_list.smartwishlist.model.SmartWishListUpdateWishListData}
     * @return the request
     */
    public Update update(java.lang.String clientId, java.lang.Double timestamp, java.lang.String signature, com.appspot.smart_wish_list.smartwishlist.model.SmartWishListUpdateWishListData content) throws java.io.IOException {
      Update result = new Update(clientId, timestamp, signature, content);
      initialize(result);
      return result;
    }
    ...
    public class Update extends SmartwishlistRequest<Void> {
      ...
      private static final String REST_PATH = "updatewishlist";
       ...
       * @since 1.13
       */
      protected Update(java.lang.String clientId, java.lang.Double timestamp, java.lang.String signature, com.appspot.smart_wish_list.smartwishlist.model.SmartWishListUpdateWishListData content) {
        super(Smartwishlist.this, "POST", REST_PATH, content, Void.class);
        this.clientId = com.google.api.client.util.Preconditions.checkNotNull(clientId, "Required parameter clientId must be specified.");
        this.timestamp = com.google.api.client.util.Preconditions.checkNotNull(timestamp, "Required parameter timestamp must be specified.");
        this.signature = com.google.api.client.util.Preconditions.checkNotNull(signature, "Required parameter signature must be specified.");
