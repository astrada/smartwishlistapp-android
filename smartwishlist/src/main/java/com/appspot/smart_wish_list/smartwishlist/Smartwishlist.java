...
public class Smartwishlist extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class AppNotifications {
     ...
     * @param timestamp
     * @param signature
     * @param content the {@link com.appspot.smart_wish_list.smartwishlist.model.SmartWishListAppNotificationParameters}
     * @return the request
     */
    public List list(java.lang.String clientId, java.lang.Double timestamp, java.lang.String signature, com.appspot.smart_wish_list.smartwishlist.model.SmartWishListAppNotificationParameters content) throws java.io.IOException {
      List result = new List(clientId, timestamp, signature, content);
      initialize(result);
      return result;
    }
    ...
    public class List extends SmartwishlistRequest<com.appspot.smart_wish_list.smartwishlist.model.SmartWishListAppNotificationData> {
       ...
       * @since 1.13
       */
      protected List(java.lang.String clientId, java.lang.Double timestamp, java.lang.String signature, com.appspot.smart_wish_list.smartwishlist.model.SmartWishListAppNotificationParameters content) {
        super(Smartwishlist.this, "POST", REST_PATH, content, com.appspot.smart_wish_list.smartwishlist.model.SmartWishListAppNotificationData.class);
